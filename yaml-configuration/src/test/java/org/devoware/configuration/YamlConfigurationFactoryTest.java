...
import org.devoware.configuration.test.fixtures.CompositeConfiguration;
import org.devoware.configuration.test.fixtures.DatabaseConfiguration;
import org.devoware.configuration.test.fixtures.HostConfiguration;
import org.devoware.configuration.test.fixtures.SimpleConfiguration;
import org.devoware.configuration.test.fixtures.SimpleConfigurationWithValidation;
...
public class YamlConfigurationFactoryTest {
  ...
  public void test_load_simple_configuration() throws IOException, ConfigurationException {
    ...
    ConfigurationFactory<SimpleConfiguration> configFactory =
        new YamlConfigurationFactory<>(SimpleConfiguration.class, new ObjectMapper());
  ...
  public void test_load_simple_configuration_with_different_data_types()
    ...
    ConfigurationFactory<HostConfiguration> configFactory =
        new YamlConfigurationFactory<>(HostConfiguration.class, new ObjectMapper());
  ...
  public void test_load_composite_configuration() throws IOException, ConfigurationException {
    ...
    ConfigurationFactory<CompositeConfiguration> configFactory =
        new YamlConfigurationFactory<>(CompositeConfiguration.class, new ObjectMapper());
  ...
  public void test_load_simple_configuration_with_validation()
    ...
    ConfigurationFactory<SimpleConfigurationWithValidation> configFactory =
        new YamlConfigurationFactory<>(SimpleConfigurationWithValidation.class, new ObjectMapper(),
